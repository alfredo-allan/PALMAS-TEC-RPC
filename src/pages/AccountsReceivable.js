...
export default function AccountsReceivable() {
        ...
        [
            {
                ...
                options: [
                    {
                        value: "1652",
                        label: "1652 - WEB PALMAS PAPELARIA E INFORMATICA - 10.552.934/0001-90",
                    },
    ...
    const tableData = [
        {
            id: "1",
            cliente: "15 - SOLUGAO TI ASSISTENCIA TECNICA EM INFORMATICA LTDA - 10.552.934/C 2",
            codigo: "10",
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300", children: [_jsx(Header, {}), _jsx(DataFilter, { filters: filters, onFilterChange: setFilters }), _jsx("main", { className: "max-w-full mx-auto py-8", children: _jsx("div", { className: "space-y-6", children: _jsx(DataTable, { data: tableData, onRowSelect: handleRowSelect }) }) })] }));
}
